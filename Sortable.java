...
public class Sortable {
	...
	public static void main(String[] args) 
	{
				...
				// Load the url
				chromeDriver.get("https://jqueryui.com/sortable");
				...
				WebElement draggableWE = chromeDriver.findElement(By.xpath("//ul[@id='sortable']/li[7]"));
				
				//Find element where it has to be dropped
				WebElement droppableWE = chromeDriver.findElement(By.xpath("//ul[@id='sortable']/li[1]"));
				
				//Wait for 3 secs until the web element is visible
				webDriverWait.until(ExpectedConditions.visibilityOf(draggableWE));
				
				//Wait for 3 secs until the web element is visible
				webDriverWait.until(ExpectedConditions.visibilityOf(droppableWE));
